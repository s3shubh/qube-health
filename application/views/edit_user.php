<div class="col-md-9">
    <div class="profile-content">
        <div class="p-3 py-5">
            <form method="POST" action="<?php echo base_url('admin/edit_user/' . $user_id); ?>"
                        ...
                        <div class="controls">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"
                                    ...
                                    <?php } else { ?>
                                    <img src="<?php echo base_url() . 'assets/images/profile/' . $user['profile_image']; ?>"
                                        alt="No Image">
